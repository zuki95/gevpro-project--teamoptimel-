...
if __name__ == "__main__":
    ...
    ship1 = BattleShip(1, 1, "H")
    ship2 = BattleShip(2, 1, "O")
    ship3 = BattleShip(3, 1, "I")
    ship4 = BattleShip(5, 1, "D")
    ship5 = BattleShip(6, 1, "O")
    ship6 = BattleShip(7, 1, "E")
    ship7 = BattleShip(8, 1, "I")
    ship8 = BattleShip(4, 4, "H")
    ship9 = BattleShip(5, 4, "A")
    ship10 = BattleShip(6, 4, "L")
    ship11 = BattleShip(7, 4, "L")
    ship12 = BattleShip(8, 4, "O")
